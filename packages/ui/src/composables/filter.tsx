...
import { getPropertyFromItem, propsFactory, wrapInArray } from '@/utils'
...
function normaliseMatch(
  match: FilterMatch,
  query: string
): FilterMatchArrayMultiple | undefined {
...
export function useFilter<T extends InternalItem>(
  ...
  const filteredMatches = shallowRef(
    new Map<unknown, Record<string, FilterMatchArrayMultiple | undefined>>()
  )
...
export function highlightResult(
  name: string,
  text: string,
  matches: FilterMatchArrayMultiple | undefined
) {
