...
import { mergeDeep, toKebabCase } from '../utils/helpers'
import { injectSelf } from '../utils/injectSelf'
...
// Types
import type { ComputedRef, InjectionKey, MaybeRef, Ref, VNode } from 'vue'
...
export function injectDefaults() {
  ...
  if (!defaults) throw new Error('[Speed] Could not find defaults instance')
...
export function internalUseDefaults(
  ...
  if (!name) {
    throw new Error('[Speed] Could not determine component name')
  }
