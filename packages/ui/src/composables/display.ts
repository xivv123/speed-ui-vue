...
import { getCurrentInstanceName, mergeDeep, propsFactory } from '../utils'
...
export function useDisplay(
  ...
  if (!display) throw new Error('Could not find Speed display injection')
  ...
  const mobile = computed(() => {
    if (props.mobile) {
      ...
      return (
        display.width.value < display.thresholds.value[props.mobileBreakpoint]
      )
