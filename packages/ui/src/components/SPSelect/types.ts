...
export type Val<T, ReturnObject extends boolean> = [T] extends [Primitive]
  ? T
...
export type SPSelectSlots<Item = any> = Omit<SPInputSlots & SPFieldSlots, 'default'> & {
  item: {
    item: ListItem<Item>
    index: number
